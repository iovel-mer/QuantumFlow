      ...
      <main className="min-h-screen pt-6 sm:pt-8 md:pt-10 container mx-auto px-4 relative bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto rounded-2xl shadow-xl p-6 sm:p-10 border border-gray-200">
          ...
          <div className="text-center mb-8 sm:mb-10 lg:mb-12">
            <Badge variant="secondary" className="mb-3 sm:mb-4 px-3 py-1 text-xs sm:text-sm">
              {t("badge")}
            </Badge>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 mt-6 sm:mt-8 text-xs sm:text-sm">
              <div className="flex items-center gap-1 sm:gap-2 px-3 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
          ...
          <div className="space-y-6 sm:space-y-8 md:space-y-10">
            <article className="prose prose-lg prose-gray max-w-none dark:prose-invert">
              ...
              {/* Additional sections for other table of contents items */}
