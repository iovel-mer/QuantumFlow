...
export const Footer = () => {
  ...
  return (
    <footer id="about" className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden">
      ...
      <div className="relative z-10 py-20 text-white">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          {/* Bottom Section */}
          <div className="pt-12 flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
              <p className="text-white/60 text-sm">© {new Date().getFullYear()} CryptoTrade Pro. {t("rights")}</p>
            </div>
